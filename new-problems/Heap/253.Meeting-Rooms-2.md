...
- What I learned:
  usage of lambda function to sort based on start time = intervals.sort(key=lambda x:x[0]). heap usage = heapq.heappush(data structure like array, end time of the meeting)
